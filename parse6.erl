...
test_parse1()-> #{arguments :={{error,{name_without_value,_Module,_LineOfCode,"var2"}},<<>>},
                  host := <<"aa.com">>,
                  path := <<"path/">>,
                  port := <<"8888">>,
                  scheme := <<"https">>,
...
test_parse2()-> #{arguments := {error, {bad_arguments,{bad_path,{bad_port,<<"$$bad_port$$">>}}}},
                 host   := <<"aa.com">>,
                 path   := error,
                 port   := <<"80">>,
                 scheme := <<"https">>,
...
test_parse3()-> #{arguments := {error,{bad_arguments,{bad_path,{bad_port,<<>>}}}},
                  host      := <<"aa.com">>,
                  path      := error,
                  port      := <<"80">>,
                  scheme    := <<"https">>,
...
test_parse4()-> #{arguments := {#{"var1" := "value1"},<<>>},
                  host      := <<"aa.com">>,
                  path      := <<"path/">>,
                  port      := <<"80">>,
                  scheme    := <<"https">>,
...
test_parse5()->  #{arguments := {#{"username" := "tralala"},<<>>}, 
...
test_parse6()->  #{arguments := {#{"username" := "tralala"},<<>>},
                   host := <<"api.example.com">>,
                   path := <<"users">>,
                   port := <<"80">>,
                   scheme := <<"https">>,
...
test_parse7()->  #{arguments := {#{"var1"  := "tralala","var2" := "value2"},<<>>},
                                    host   := <<"api.example.com">>,
                                    path   := <<"users">>,
                                    port   := <<"80">>,
                                    scheme := <<"https">>,
...
test_parse8()->  #{arguments := {#{"var1" := "tralala","var2" := "value2"},<<>>},
                   host   := <<"api.example.com">>,
                   path   := <<"users">>,
                   port   := <<"8888">>,
                   scheme := <<"https">>, 
